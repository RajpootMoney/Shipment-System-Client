      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            A modern, comprehensive shipment management system built with
            Next.js, TypeScript, and Tailwind CSS. Track shipments, manage
            users, and streamline your logistics operations.
          </p>
          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <p className="text-gray-600 mb-6">
              This is a feature-based Next.js application with the following
              structure:
            </p>
